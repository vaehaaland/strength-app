...
export default function ProgramsPage() {
  ...
  const [dayAccessories, setDayAccessories] = useState<{ exerciseId: string; sets: number; reps: number }[][]>([
    [], [], [], []
  ])
  ...
  function addDayAccessoryRow(dayIndex: number) {
    ...
    updated[dayIndex] = [...updated[dayIndex], { exerciseId: '', sets: 3, reps: 12 }]
                          ...
                          {dayAccessories[wizardStep - 1].map((ex, index) => (
                            <div key={index} className="p-4 border border-zinc-200 dark:border-zinc-700 rounded-lg">
                              ...
                              <button
                                ...
                                className="mt-2 p-2 text-red-600 hover:bg-red-50 dark:hover:bg-red-950 rounded-lg"
                              >
